...
open class LandscapeRBatteryDrawableColorOS(private val context: Context, frameColor: Int) :
    ...
    fun setChargingEnabled(charging: Boolean) {
    ...
    fun setPowerSavingEnabled(powerSaveEnabled: Boolean) {
    ...
    fun setShowPercentEnabled(showPercent: Boolean) {
